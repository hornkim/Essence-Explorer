...
There is no manual yet but the PDF provides some explanation. The edit page allows you to create prolog code for a few of the Essence Entities. You need to paste the code generated into the prolog app.
The chatbot code will come soon.
If you want to coloborate on this send me a message.
